"""
Django settings for Sombreando project.
"""
...
WSGI_APPLICATION = 'sombreando.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('DB_NAME', default='sombreando_db'),
        'USER': config('DB_USER', default='sombreando'),
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@sombreando.com')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Sombreando API',
    'DESCRIPTION': 'API completa para o microSaaS Sombreando',
    'VERSION': '1.0.0',
